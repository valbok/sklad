...
uses
  ...
  UnitCreateWhere in 'UnitCreateWhere.pas' {frmCreateWhere},
  UnitInputValue in 'UnitInputValue.pas' {frmInputValue},
  UnitBetween in 'UnitBetween.pas' {frmBetween},
...
begin
  ...
  Application.CreateForm(TfrmCreateWhere, frmCreateWhere);
  Application.CreateForm(TfrmInputValue, frmInputValue);
  Application.CreateForm(TfrmBetween, frmBetween);
